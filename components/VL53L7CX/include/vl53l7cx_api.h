...
#define VL53L7CX_API_REVISION "VL53L7CX_2.0.0"
...
#define VL53L7CX_STATUS_XTALK_FAILED ((uint8_t)4U)
...
#define VL53L7CX_NB_TARGET_DETECTED_BH ((uint32_t)0xDB840401U)
#define VL53L7CX_SIGNAL_RATE_BH ((uint32_t)0xDBC40404U)
#define VL53L7CX_RANGE_SIGMA_MM_BH ((uint32_t)0xDEC40402U)
#define VL53L7CX_DISTANCE_BH ((uint32_t)0xDF440402U)
#define VL53L7CX_REFLECTANCE_BH ((uint32_t)0xE0440401U)
#define VL53L7CX_TARGET_STATUS_BH ((uint32_t)0xE0840401U)
#define VL53L7CX_MOTION_DETECT_BH ((uint32_t)0xD85808C0U)
...
#define VL53L7CX_NB_TARGET_DETECTED_IDX ((uint16_t)0xDB84U)
#define VL53L7CX_SIGNAL_RATE_IDX ((uint16_t)0xDBC4U)
#define VL53L7CX_RANGE_SIGMA_MM_IDX ((uint16_t)0xDEC4U)
#define VL53L7CX_DISTANCE_IDX ((uint16_t)0xDF44U)
#define VL53L7CX_REFLECTANCE_EST_PC_IDX ((uint16_t)0xE044U)
#define VL53L7CX_TARGET_STATUS_IDX ((uint16_t)0xE084U)
#define VL53L7CX_MOTION_DETEC_IDX ((uint16_t)0xD858U)
...
#define VL53L7CX_DCI_VHV_CONFIG ((uint16_t)0xAD60U)
...
#define VL53L7CX_DCI_SYNC_PIN ((uint16_t)0xB5F0U)
#define VL53L7CX_DCI_MOTION_DETECTOR_CFG ((uint16_t)0xBFACU)
#define VL53L7CX_DCI_SINGLE_RANGE ((uint16_t)0xD964U)
#define VL53L7CX_DCI_OUTPUT_CONFIG ((uint16_t)0xD968U)
#define VL53L7CX_DCI_OUTPUT_ENABLES ((uint16_t)0xD970U)
#define VL53L7CX_DCI_OUTPUT_LIST ((uint16_t)0xD980U)
#define VL53L7CX_DCI_PIPE_CONTROL ((uint16_t)0xDB80U)
#define VL53L7CX_GLARE_FILTER ((uint16_t)0xE108U)
...
#define VL53L7CX_MAX_RESULTS_SIZE                                              \
...
#ifndef VL53L7CX_DISABLE_RANGE_SIGMA_MM
    uint16_t
        range_sigma_mm[(VL53L7CX_RESOLUTION_8X8 * VL53L7CX_NB_TARGET_PER_ZONE)];
#endif

    /* Measured distance in mm */
#ifndef VL53L7CX_DISABLE_DISTANCE_MM
    int16_t
        distance_mm[(VL53L7CX_RESOLUTION_8X8 * VL53L7CX_NB_TARGET_PER_ZONE)];
#endif

    /* Estimated reflectance in percent */
#ifndef VL53L7CX_DISABLE_REFLECTANCE_PERCENT
    uint8_t
        reflectance[(VL53L7CX_RESOLUTION_8X8 * VL53L7CX_NB_TARGET_PER_ZONE)];
#endif

    /* Status indicating the measurement validity (5 & 9 means ranging OK)*/
#ifndef VL53L7CX_DISABLE_TARGET_STATUS
    uint8_t
        target_status[(VL53L7CX_RESOLUTION_8X8 * VL53L7CX_NB_TARGET_PER_ZONE)];
#endif
 ...
 * @param (VL53L7CX_Configuration) *p_dev : VL53L7CX configuration structure.
 */
uint8_t vl53ll7cx_enable_internal_cp(VL53L7CX_Configuration *p_dev);
 ...
 * @param (VL53L7CX_Configuration) *p_dev : VL53L7CX configuration structure.
 */
uint8_t vl53ll7cx_disable_internal_cp(VL53L7CX_Configuration *p_dev);

/**
 * @brief This function is used to get the number of frames between 2
